...
public class Electronics extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        dataSet.add(new Item_Product(getResources().getString(R.string.elec_1),
                                    getResources().getString(R.string.store_1),
                                    getResources().getString(R.string.phone_1),
                                    getResources().getString(R.string.city_1),
                                    ResourcesCompat.getDrawable(getResources(),R.drawable.nswitch, null),
                                     ResourcesCompat.getDrawable(getResources(), R.drawable.bestbuy, null)));

        dataSet.add(new Item_Product(getResources().getString(R.string.elec_2),
                                    getResources().getString(R.string.store_1),
                                    getResources().getString(R.string.phone_1),
                                    getResources().getString(R.string.city_2),
                                    ResourcesCompat.getDrawable(getResources(), R.drawable.nesmini, null),
                                    ResourcesCompat.getDrawable(getResources(), R.drawable.bestbuy, null)));
